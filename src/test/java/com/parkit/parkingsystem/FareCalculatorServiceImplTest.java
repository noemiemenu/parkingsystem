...
public class FareCalculatorServiceImplTest {
    ...
    @Test
    public void calculateFareCarWithOneHourFifteenWhichMustBeRoundedOffToTwoHours() {
        Date inTime = new Date();
        inTime.setTime(System.currentTimeMillis() - (115 * 60 * 1000));//45 minutes parking time should give 3/4th parking fare
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR, false);
    ...
    @Test
    public void FreeParkingTimeFirstHalfHour(){
        Date inTime = new Date();
        inTime = DateUtils.addMinutes(inTime, -30);
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR, false);
        ticket.setInTime(inTime);
        ticket.setOutTime(outTime);
    ...
    @Test
    public void PayAfterFirstHalfMinute(){
        Date inTime = new Date();
        inTime = DateUtils.addMinutes(inTime, -31);
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR, false);
        ticket.setInTime(inTime);
        ticket.setOutTime(outTime);
    ...
    public void DiscountForRecurringUsers(){
        ...
        assertEquals(1.4, ticket.getPrice());
    }
